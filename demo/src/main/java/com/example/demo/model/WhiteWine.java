...
@NoArgsConstructor
@Entity
@Table(name="white_wine")
public class WhiteWine {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "white_wine_seq")
    @SequenceGenerator(name = "white_wine_seq", sequenceName = "white_wine_seq", allocationSize = 1)
    private Integer id;

    public WhiteWine(Double fixed_acidity, Double volatile_acidity, Double citric_acid, Double residual_sugar, Double chlorides, Double free_sulfur_dioxide, Double total_sulfur_dioxide, Double density, Double ph, Double sulphates, Double alcohol, Double quality) {
